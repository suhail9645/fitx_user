...
class UserImageAddRepo{
  Future<Either<ErrorModel,TImage>>addUserTransformationImage(File image)async{
       try{
         final eitherResponse=await UserReportAddOperations().addTransformationImage(image);
